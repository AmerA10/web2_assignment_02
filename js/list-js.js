...
function populateCompanyList(companies) {
    companies.forEach( company => {
        ...
        + `<div class='list-item-section2'><a href = stock-api.php?symbol=${symbol}>${company.symbol}</div>`
        + `<div class='list-item-section3'><a href = stock-api.php?symbol=${symbol}>${company.name}</div>`;
